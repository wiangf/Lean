...
class FactorFile(System.object, System.Collections.IEnumerable, System.Collections.Generic.IEnumerable[FactorFileRow]):
    ...
    def __new__(self, permtick: str, data: typing.List[QuantConnect.Data.Auxiliary.FactorFileRow], factorFileMinimumDate: typing.Optional[datetime.datetime]) -> None:
        pass
...
class FactorFileRow(System.object):
    ...
    @staticmethod # known case of __new__
    def __new__(self, date: datetime.datetime, priceFactor: float, splitFactor: float, referencePrice: float) -> None:
        pass
...
class LocalDiskFactorFileProvider(System.object, QuantConnect.Interfaces.IFactorFileProvider):
    ...
    @typing.overload
    def __new__(self, mapFileProvider: QuantConnect.Interfaces.IMapFileProvider) -> None:
        pass
...
class MapFile(System.object, System.Collections.IEnumerable, System.Collections.Generic.IEnumerable[MapFileRow]):
    ...
    @staticmethod # known case of __new__
    def __new__(self, permtick: str, data: typing.List[QuantConnect.Data.Auxiliary.MapFileRow]) -> None:
        pass
...
class MapFileRow(System.object, System.IEquatable[MapFileRow]):
    ...
    @staticmethod # known case of __new__
    def __new__(self, date: datetime.datetime, mappedSymbol: str) -> None:
        pass
