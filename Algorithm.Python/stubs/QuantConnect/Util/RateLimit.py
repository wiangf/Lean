...
class FixedIntervalRefillStrategy(System.object, QuantConnect.Util.RateLimit.IRefillStrategy):
    ...
    def __new__(self, timeProvider: QuantConnect.ITimeProvider, refillAmount: int, refillInterval: datetime.timedelta) -> None:
        pass
...
class LeakyBucket(System.object, QuantConnect.Util.RateLimit.ITokenBucket):
    ...
    @staticmethod # known case of __new__
    @typing.overload
    def __new__(self, capacity: int, refillAmount: int, refillInterval: datetime.timedelta) -> None:
        pass

    @typing.overload
    def __new__(self, capacity: int, sleep: QuantConnect.Util.RateLimit.ISleepStrategy, refill: QuantConnect.Util.RateLimit.IRefillStrategy, timeProvider: QuantConnect.ITimeProvider) -> None:
        pass
