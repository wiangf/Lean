...
class ConstantFeeModel(QuantConnect.Orders.Fees.FeeModel, QuantConnect.Orders.Fees.IFeeModel):
    ...
    def __new__(self, fee: float, currency: str) -> None:
        pass
...
class FxcmFeeModel(QuantConnect.Orders.Fees.FeeModel, QuantConnect.Orders.Fees.IFeeModel):
    ...
    @staticmethod # known case of __new__
    def __new__(self, currency: str) -> None:
        pass
...
class InteractiveBrokersFeeModel(QuantConnect.Orders.Fees.FeeModel, QuantConnect.Orders.Fees.IFeeModel):
    ...
    @staticmethod # known case of __new__
    def __new__(self, monthlyForexTradeAmountInUSDollars: float, monthlyOptionsTradeAmountInContracts: float) -> None:
        pass
...
class OrderFee(System.object):
    ...
    @staticmethod # known case of __new__
    def __new__(self, orderFee: QuantConnect.Securities.CashAmount) -> None:
        pass
...
class OrderFeeParameters(System.object):
    ...
    """
    @staticmethod # known case of __new__
    def __new__(self, security: QuantConnect.Securities.Security, order: QuantConnect.Orders.Order) -> None:
        pass
