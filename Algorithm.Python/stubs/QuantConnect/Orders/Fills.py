...
class Fill(System.object):
    ...
    def __new__(self, orderEvent: QuantConnect.Orders.OrderEvent) -> None:
        pass
...
class FillModelParameters(System.object):
    ...
    """
    @staticmethod # known case of __new__
    def __new__(self, security: QuantConnect.Securities.Security, order: QuantConnect.Orders.Order, configProvider: QuantConnect.Interfaces.ISubscriptionDataConfigProvider, stalePriceTimeSpan: datetime.timedelta) -> None:
        pass
